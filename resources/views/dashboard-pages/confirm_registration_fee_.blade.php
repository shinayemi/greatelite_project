                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$currency}} {{number_format($item->amount_paid)}}</td>
                                                <td>{{$currency}} {{number_format($item->interest)}}</td>
                                                <td>{{$currency}} {{number_format($item->referrer_bonus)}}</td>
                                                <td>{{$item->referrer_id}}</td>
                                                <td class="text-left">{{date('l jS \of F Y h:i:s A', strtotime($item->created_at))}}</td>
                                                <td class="text-right">
                                                    @if($item->status == 'PAYING')
