            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="login-div">
                            <p class="logo mb-1"><a href="{{$appUrl}}" target="blank"><i class="fa fa-home"></i></a>{{$appName}} - Password Recovery</p>
                            <p class="mb-4" style="color: #a5b5c5">Reset your password by entering your user email.</p>
                            <form method="post" id="needs-validation" action="{{url('passwordRecovery/')}}">
                                ...
                                <small class="text-muted mt-5 mb-1 d-block"><i class="fa fa-user"></i> <a href="{{$appUrl}}login">Login</a></small>
                            </form>
                        </div>
                    </div>
                </div>
